...
@Injectable()
export class ProjectBoardQuery {
  constructor(
    @InjectModel(COMMON)
    ...
    const boardListQuery: any = await this.CommonModel.sequelize.query(
        ...
        SELECT * FROM (
            SELECT tb.ID 
                  ...
                  ,tp.POST_TITLE AS ANSWER_POST_TITLE
              FROM TB_BBS tb  
              ...
              INNER JOIN TB_PROJECT tp ON tp.PROTOCOL_NO = tb.PROTOCOL_NO
        ) t10  
          WHERE 1=1
            AND t10.DELETE_YN = 'N'
   ...
   * @returns 
   ************************************************/
  async getProjectBoardCommentInfo(params: any) {
    let { props , member, transaction } = params
    let { id , viewCountYn, bbsKindCd } = props;
   ...
   * @returns 
   ************************************************/
  async getProjectBoardInfoFiles(params: any){
    let { props , member, transaction } = params
    let { id , viewCountYn, bbsKindCd } = props;
   ...
   * @returns 
   ************************************************/
  async getProjectBoardInfoFile(params: any){
   ...
   * @returns 
   ************************************************/
    async getProjectBoardAllFiles(params: any){
      let { props, transaction } = params;
      let { fileId } = props;
      const boardInfoFilesQuery: any = await this.CommonModel.sequelize.query(
        `
